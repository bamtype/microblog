...
class WatchersControllerTest < ActionController::TestCase
  ...
  test "should create watcher" do
    assert_difference('Watcher.count') do
      post :create, watcher: { email: @watcher.email, fname: @watcher.fname, lname: @watcher.lname, password: @watcher.password, username: @watcher.username }
    end
  ...
  test "should update watcher" do
    patch :update, id: @watcher, watcher: { email: @watcher.email, fname: @watcher.fname, lname: @watcher.lname, password: @watcher.password, username: @watcher.username }
    assert_redirected_to watcher_path(assigns(:watcher))
  end
